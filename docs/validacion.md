...
| Tests | 47 casos: 6 de interacción científica, 9 de herramientas científicas, 17 de recuperación, 5 de integración independiente, 5 de exportaciones y saneado y 5 de edición en el lienzo |
...
`npm test` ejecuta los seis archivos de pruebas. Algunas versiones de Node muestran seis grupos en el resumen; ejecutando cada archivo directamente se muestran sus 47 casos. No se atribuye a esta distribución el resultado histórico de pruebas de la suite completa.
