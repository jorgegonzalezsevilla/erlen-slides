...
| Tests | 37 casos: 6 de interacción científica, 9 de herramientas científicas, 17 de recuperación y 5 de integración independiente |
...
| PowerPoint | Generado un archivo con texto, tabla y notas; integridad ZIP, XML parseable y contenido conservado |
...
Los tests de DOM usan JSDOM y almacenamiento aislado; no prueban medidas de pantalla reales. Las capturas complementan esa limitación. No se ha verificado visualmente el PPTX en Microsoft PowerPoint, ni compilado los ejemplos TEX con una distribución LaTeX. La comprobación real de RDKit no equivale a validar todas sus operaciones ni las herramientas 3D.

`npm test` ejecuta los cuatro archivos de pruebas. Algunas versiones de Node muestran cuatro grupos en el resumen; ejecutando cada archivo directamente se muestran sus 37 casos. No se atribuye a esta distribución el resultado histórico de pruebas de la suite completa.
