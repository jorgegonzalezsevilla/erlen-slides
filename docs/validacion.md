...
| Tests | 69 casos: 6 de interacción científica, 9 de herramientas científicas, 17 de recuperación, 5 de integración independiente, 5 de exportaciones y saneado, 7 de edición y composición vertical, 11 de gráficas y tablas, 4 de la frontera del montaje y 5 de la frontera de las estructuras |
...
`npm test` ejecuta los nueve archivos de pruebas. Algunas versiones de Node muestran nueve grupos en el resumen; ejecutando cada archivo directamente se muestran sus 69 casos. No se atribuye a esta distribución el resultado histórico de pruebas de la suite completa.
