...
| Tests | 64 casos: 6 de interacción científica, 9 de herramientas científicas, 17 de recuperación, 5 de integración independiente, 5 de exportaciones y saneado, 7 de edición y composición vertical, 6 de gráficas y tablas, 4 de la frontera del montaje y 5 de la frontera de las estructuras |
...
| Inspección visual | Capturas Firefox: inicio, editor, química, presentación y móvil de 390 × 844. La composición vertical se comprobó además en Chromium a 390 × 844, 360 × 640, 768 × 1024 y en apaisado, y el lienzo de estructuras con la aplicación en claro y en oscuro |
...
`npm test` ejecuta los nueve archivos de pruebas. Algunas versiones de Node muestran nueve grupos en el resumen; ejecutando cada archivo directamente se muestran sus 64 casos. No se atribuye a esta distribución el resultado histórico de pruebas de la suite completa.
