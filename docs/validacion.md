...
| Tests | 42 casos: 6 de interacción científica, 9 de herramientas científicas, 17 de recuperación, 5 de integración independiente y 5 de exportaciones y saneado |
...
`npm test` ejecuta los cinco archivos de pruebas. Algunas versiones de Node muestran cinco grupos en el resumen; ejecutando cada archivo directamente se muestran sus 42 casos. No se atribuye a esta distribución el resultado histórico de pruebas de la suite completa.
