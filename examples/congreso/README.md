...
Una charla breve con un mensaje, una figura y una limitación.
...
¿Qué resultado concreto debe recordar la audiencia?

1. Inicia Erlen Slides y abre «Ejemplos editables → Comunicación de congreso», o importa [proyecto.json](proyecto.json).
...
- Tiempo total ensayado y notas breves
- Figura legible desde el fondo de la sala
- Contacto y referencias autorizados para difusión
