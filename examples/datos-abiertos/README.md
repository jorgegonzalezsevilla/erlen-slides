...
Preparar archivos reutilizables antes de depositarlos.
...
¿Qué necesita otra persona para reutilizar este conjunto de datos?

1. Inicia Erlen Slides y abre «Ejemplos editables → Plan de datos abiertos», o importa [proyecto.json](proyecto.json).
...
- Diccionario, formatos abiertos y checksums
- Consentimientos y permisos que correspondan
- Versión, licencia y cita del depósito
