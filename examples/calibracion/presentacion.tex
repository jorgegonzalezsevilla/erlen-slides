  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[only marks, mark=*, mark size=1.9pt, serieA] coordinates {
        (0,0.01) (1,0.13) (2,0.25) (3,0.37) (4,0.49) 
        };
        \addplot[serieA, line width=.9pt, mark=none, forget plot] coordinates {(0,0.01) (4,0.49)};
        \node[anchor=north west, align=left, font=\footnotesize, fill=erlenfondo, fill opacity=0.72, text opacity=1, inner sep=2pt] at (rel axis cs:0.03,0.97) {$y = 0.12\,x + 0.01$ \quad $R^{2} = 1.0000$};
      \end{axis}
    \end{tikzpicture}
