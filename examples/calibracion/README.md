...
De los patrones a la discusión del intervalo de trabajo.
...
¿Qué intervalo de concentración permite una calibración útil?

1. Inicia Erlen Slides y abre «Ejemplos editables → Calibración UV–Vis», o importa [proyecto.json](proyecto.json).
...
- Identidad del analito, disolvente y longitud de onda
- Unidades, incertidumbre y trazabilidad de los patrones
- Residuos, réplicas y validación independiente
