...
\definecolor{erlenfondo}{HTML}{F7FAFB}
...
\title[Perfil espectral]{Perfil espectral}
...
\begin{frame}{La pregunta que guía el trabajo}
  \transdissolve[duration=0.25]
  {\large ¿Una señal es consistente con el componente que buscamos?}
  \medskip
...
\begin{frame}{Una estrategia explícita}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[x=1cm,y=1cm,font=\footnotesize]
      ...
      \node[text=sat1843819360, align=center, text width=1.75cm, inner sep=1pt] at (1.113,-1.254) {\bfseries Adquirir un blanco};
      \node[text=sat1843819360, align=center, text width=1.75cm, inner sep=1pt] at (3.976,-1.254) {\scriptsize \bfseries Documentar el preprocesamiento};
      \node[text=sat1843819360, align=center, text width=1.75cm, inner sep=1pt] at (6.620,-1.254) {\bfseries Mostrar señal y unidades};
      \node[text=sat1226267613, align=center, text width=1.75cm, inner sep=1pt] at (9.264,-1.254) {\bfseries Contrastar la asignación};
    \end{tikzpicture}
  \end{figure}
\end{frame}
\note{%
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        xlabel={Coordenada espectral (u.a.)},
        ...
        \addplot[serieA, line width=1pt, mark=*, mark size=1.7pt, smooth] coordinates {
        (0,0.001) (1,0.044) (2,0.458) (3,1) (4,0.458) (5,0.044) (6,0.001) 
        };
      \end{axis}
    \end{tikzpicture}
...
\begin{frame}{Interpretación y límites}
  \transdissolve[duration=0.25]
  \begin{itemize}
    \item Perfil gaussiano sintético; el eje no representa una técnica particular.
    \item Una coincidencia visual no basta para asignar una especie.
    \item Declarar suavizado, normalización y corrección de línea base.
  \end{itemize}
\end{frame}
\note{%
  {\scriptsize\textbf{Tiempo previsto: 1:30 min}}\par\medskip
...
\begin{frame}{Antes de compartir}
  \transdissolve[duration=0.25]
  \begin{itemize}
    \item Técnica, resolución y calibración del eje
    \item Datos crudos y parámetros de preprocesamiento
    \item Referencia verificable para cada asignación
  \end{itemize}
  \medskip
