...
Un resultado que conserva el camino desde el archivo original.
...
¿Puede otra persona reconstruir la figura desde los mismos datos?

1. Inicia Erlen Slides y abre «Ejemplos editables → Análisis reproducible», o importa [proyecto.json](proyecto.json).
...
- Comando de ejecución y dependencias fijadas
- Semillas cuando exista aleatoriedad
- Identificador de versión y licencia de datos
